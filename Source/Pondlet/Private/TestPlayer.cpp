...
void ATestPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		// Moving
		EnhancedInputComponent->BindAction(MovementAction, ETriggerEvent::Triggered, this, &ATestPlayer::Move);

		// Enable Rotation
		EnhancedInputComponent->BindAction(EnableRotationAction, ETriggerEvent::Started, this, &ATestPlayer::EnableRotation);

		// Disable Rotation
		EnhancedInputComponent->BindAction(EnableRotationAction, ETriggerEvent::Completed, this, &ATestPlayer::EnableRotation);

		// Rotating
		EnhancedInputComponent->BindAction(RotationAction, ETriggerEvent::Triggered, this, &ATestPlayer::Rotate);

		// Zooming In
		EnhancedInputComponent->BindAction(ZoomInAction, ETriggerEvent::Triggered, this, &ATestPlayer::ZoomIn);

		// Zooming Out
		EnhancedInputComponent->BindAction(ZoomOutAction, ETriggerEvent::Triggered, this, &ATestPlayer::ZoomOut);
	}
	else
	{
...
void ATestPlayer::EnableRotation(const FInputActionValue& Value)
{
	bIsRotationEnabled = !bIsRotationEnabled;
}

void ATestPlayer::Rotate(const FInputActionValue& Value)
{
...
void ATestPlayer::ZoomIn(const FInputActionValue& Value)
{
...
void ATestPlayer::ZoomOut(const FInputActionValue& Value)
{
...
void ATestPlayer::ApplySettings()
{
...
void ATestPlayer::InitPlayerBoundaries()
{
...
void ATestPlayer::ClampPosition(USceneComponent* MinPlayerBoundary, USceneComponent* MaxPlayerBoundary)
{
...
void ATestPlayer::UpdateMovementSpeedCorrectionFactor()
{
